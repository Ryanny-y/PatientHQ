    ...
    <div className="bg-white rounded-xl border border-slate-100 shadow-sm overflow-hidden">
        ...
        <table className="w-full text-sm">
          <thead>
            <tr className="border-b border-slate-100 bg-slate-50/60">
              <th className="text-left px-5 py-3.5 text-xs font-semibold text-slate-500 uppercase tracking-wider whitespace-nowrap">
                Admin ID
              </th>
              ...
              <th className="text-right px-5 py-3.5 text-xs font-semibold text-slate-500 uppercase tracking-wider sticky right-0 bg-slate-50/60">
                Actions
              </th>
            </tr>
          </thead>
                ...
                >
                  ...
                  <td className="px-5 py-4">
                    <span className="font-mono text-xs text-slate-400 bg-slate-100 px-2 py-0.5 rounded">
                      ADM-{String(admin.adminId).padStart(4, "0")}
                    </span>
                  </td>
                  {/* Username */}
                  <td className="px-5 py-4">
                  ...
                  {/* Full name */}
                  <td className="px-5 py-4 text-slate-700">{admin.fullName}</td>
                  {/* Email */}
      ...
      <div className="px-5 py-3.5 border-t border-slate-100 flex items-center justify-between gap-4">
        <p className="text-xs text-slate-400">
          {totalFiltered === 0
            ? "No results"
            : `Showing ${from}–${to} of ${totalFiltered} admins`}
        </p>
