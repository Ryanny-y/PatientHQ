...
import { MoreVertical, Eye, Edit, History, UserPlus, FileText, Archive } from 'lucide-react';
        ...
        <Table>
          <TableHeader>
            <TableRow className="bg-slate-50">
              ...
              <TableHead className="font-semibold text-right sticky right-0 bg-slate-50">Actions</TableHead>
            </TableRow>
          </TableHeader>
          <TableBody>
            {patients.length === 0 ? (
